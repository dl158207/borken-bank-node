...
// Lisa hat Durchnittsnote 3, Tim hat Durschnittsnote 4, Max hat die Durschnittsnote 5.
...
if (durschnitt < matchMedia(lisa,Tim,Max)){
    Zeugnis.Klassenbeste = true; // Es wird im Zeugnis eine neue Eigenschaft ergäzt.
    console.log("Lisa hat einen Durschnitt von " * + durschnitt + " Sie ist nicht Klassenbeste ")
}else{
...
class Produkt = {
    constructor(){
        this.Art
        this.Mehrwertsteuersatz     // Eigenschften beginnen immer mit Großbuchstaben
        this.Mehrwertsteuer         // 
        this.Nettorechnungsbetrag
        this.Brutorechnungsbetrag
        this.Skontosatz
        this.Skontosatz
        this.Zahlungsbetrag
        this.Rabatt
...
produkt.Nettorechnungsbetrag = 370  // Bitte kein Komma, sondern den Punkt für Nach kommastelle
                                    // verwenden
                                    // Bitte keine Einhe (z.B EUR)
                                    //
...
produkt.Mehrwertsteuersatz = produkt.Nettorechnungsbetrag * produkt.Mehrwertsteuersatz
...
produkt.Brutorechnungsbetrag = produkt.Nettorechnungsbetrag * produkt.Mehrwertsteuer

console.log ("Brutoberechnungsbetrag: " + produkt.Brutorechnungsbetrag)
